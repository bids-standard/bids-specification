...
Inside the `sub-001/anat/c1sub-001_T1w.json` file, the metadata field `GeneratedBy` indicates that the `c1sub-001/anat/sub-001_T1w.nii.gz` file was generated by the previously described activity.
