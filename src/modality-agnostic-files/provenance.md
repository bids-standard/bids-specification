...
!!! Note
    ...
    `Id` is used to unambiguously [identify those objects](#provenance-identifiers)
    ...
    [`label`](../glossary.md#label-common_principles).
...
the metadata field `GeneratedBy` indicates that the `sub-001/anat/c1sub-001_T1w.nii.gz` file
