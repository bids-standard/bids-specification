...
| DigitizedLandmarks  | REQUIRED              | [boolean][]                          | `true` or `false` value indicating whether anatomical landmark points (that is fiducials) are contained within this recording.                                                                                                                                                                                                                                       |
