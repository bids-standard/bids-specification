...
trans, quat, mc, and so on), which some installations impose to be run on raw data
...
| DigitizedLandmarks  | REQUIRED              | [boolean][]                          | `true` or `false` value indicating whether anatomical landmark points (meaning fiducials) are contained within this recording.                                                                                                                                                                                                                                       |
...
empty-room recording in the format `YYYYMMDD`, such as `ses-YYYYMMDD`.
