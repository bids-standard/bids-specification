...
{{ MACROS___make_metadata_table(
   {
      ...
      "ReconFilterType": ("REQUIRED","his partly matches the DICOM Tag (0018,1210) 	`Convolution Kernel`."),
      "ReconFilterSize": ("REQUIRED","his partly matches the DICOM Tag (0018,1210) 	`Convolution Kernel`."),
