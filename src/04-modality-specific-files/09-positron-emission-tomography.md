...
| DoseCalibrationFactor                | RECOMMENDED           | [number][]                             | Factor that was used to scale this image from counts/sec to Bq/ml using a dose calibrator (dicom tag 0054,1322). |
