...
| CalibrationFactor           | RECOMMENDED           | [number][]    | Value used to calibrate radioactivity count, i.e. transfom to meaningful unit (e.g. Becquerel) - value already applied to the data as a multiplication factor. |
