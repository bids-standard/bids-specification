...
| InfusionRadioactivity         | RECOMMENDED           | [number][]    | Amount of radioactivity infused into the patient. This value must be less than or equal to the total injected radioactivity (`InjectedRadioactivity`). Units should be the same as `InjectedRadioactivityUnit`.                                                                |
| InfusionStart                 | RECOMMENDED           | [number][]    | Time of start of infusion with respect to `TimeZero` in the default unit seconds.                                                                                                                                                                                              |
...
| InjectedVolume                | RECOMMENDED           | [string][]    | Injected volume of the radiotracer in the unit `"mL"`.                                                                                                                                                                                                                         |
