...
| **Key name**  | **Requirement level** | **Data type** | **Description**                                                                                                                                                                                                                                                                                                                                                                                                      |   |
| ------------- | --------------------- | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | - |
| component     | REQUIRED              | string        | Component of the representational system described in `*_coordinatesystem.tsv` that the channel contains. Must be one of: "x" ,"y", "z", "n/a".                                                                                                                                                                                                                                                                      |   |
...
| type          | REQUIRED              | string        | Type of data. Position, orientation, acceleration or any related format. Can also be latency. Must be one of: "ACC", "ANGVEL", "JNTANG", "LATENCY", "MAGN", "MISC", "ORNT", "POS", "VEL".                                                                                                                                                                                                                            |   |
