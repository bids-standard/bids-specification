...
| RecordingType              | RECOMMENDED           | string        | Defines whether the recording is  "continuous” or  "epoched”; this latter limited to time windows about events of interest (e.g., stimulus presentations, subject responses, and so on)                                                                                                |
...
| units           | REQUIRED              | string        | Physical unit of the value represented in this channel, e.g., vm for virtual meters, radian or degrees for angular quantities. See the BIDS spec for guidelines for Units and Prefixes.                             |
