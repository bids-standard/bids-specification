...
| T1 weighted        | T1w              |                                                                                                                                                   |
| T2 weighted        | T2w              |                                                                                                                                                   |
| T1 Rho map         | T1rho            | Quantitative T1rho brain imaging <br> [https://www.ncbi.nlm.nih.gov/pubmed/24474423](https://www.ncbi.nlm.nih.gov/pubmed/24474423) <br> [https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4346383/](https://www.ncbi.nlm.nih.gov/pubmed/24474423) |
...
files: `*_asl.json` and `*_aslcontext.tsv`. The raw BIDS NIfTIs should contain appropriately scaled data and no scaling factors 
...
The `*_aslcontext.tsv` lists the volume_type for each volume in the `*_asl.nii[.gz]`, corresponding to the volume_types 
