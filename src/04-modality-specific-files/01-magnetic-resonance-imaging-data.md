...
| SpoilingGradientDuration    | RECOMMENDED if the SpoilingType is `GRADIENT` or `COMBINED`. | [number][]                            | The duration of the spoiler gradient lobe in seconds. The duration of a trapezoidal lobe is defined as the summation of ramp-up and plateu times.                                                                                                                                                                                            |
