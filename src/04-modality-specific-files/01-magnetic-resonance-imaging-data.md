...
Depending on the method used for ASL acquisition (i.e. (P)CASL or PASL) different metadata fields are applicable.
...
| PulseSequenceType                 | REQUIRED                                                                                                                               | \[string\]\[\]                                       | General description of the pulse sequence used for the scan\. Allowed values are any combination of 2D or 3D acquisition, with the read\-out type, separated by an underscore: for example “2D\_EPI”, “3D\_GRASE”, “3D\_spiral”\.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
