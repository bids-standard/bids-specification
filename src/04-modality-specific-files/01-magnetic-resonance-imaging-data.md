...
| Equilibrium magnetization (M0) map           | M0map     | In arbitrary units (a.u.). A common quantitative MRI (qMRI) fitting variable that represents the amount of magnetization at thermal equilibrium. M0 maps are RECOMMENDED to use this suffix if derived from qMRI applications (e.g. variable flip angle T1 mapping).                                                                                                                                                                                                                                                                                                                                                                            |
