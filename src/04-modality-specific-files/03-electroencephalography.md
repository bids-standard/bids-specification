...
| EEGCoordinateSystemDescription | RECOMMENDED           | [string][]    | Free-form text description of the coordinate system. May also include a link to a documentation page or paper describing the system in greater detail. REQUIRED if `EEGCoordinateSystem` is `Other`.                                                                     |
...
| FiducialsCoordinateSystemDescription | RECOMMENDED           | [string][]               | Free-form text description of the coordinate system. May also include a link to a documentation page or paper describing the system in greater detail. REQUIRED if `FiducialsCoordinateSystem` is `Other`.                                                                                                                                                      |
...
| AnatomicalLandmarkCoordinateSystemDescription | RECOMMENDED           | [string][]               | Free-form text description of the coordinate system. May also include a link to a documentation page or paper describing the system in greater detail. REQUIRED if `AnatomicalLandmarkCoordinateSystem` is `Other`.                                                                                                                                                      |
