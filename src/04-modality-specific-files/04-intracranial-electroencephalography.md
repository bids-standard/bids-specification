...
sub-<label>/
  [ses-<label>]/
    ieeg/
      sub-<label>[_ses-<label>]_task-<label>[_acq-<acquisition>][_run-<index>]_ieeg.<manufacturer_specific_extension>
      sub-<label>[_ses-<label>]_task-<label>[_acq-<acquisition>][_run-<index>]_ieeg.json
```
