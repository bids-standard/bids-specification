...
| ElectricalStimulationParameters | OPTIONAL              | [string][]    | Free form description of stimulation parameters, such as frequency, shape, and so on. Specific onsets can be specified in the events.tsv file. Specific shapes can be described here in freeform text.                         |
