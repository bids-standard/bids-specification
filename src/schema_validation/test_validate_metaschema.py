...
def test_broken_reference():
    ...
    schema = load_schema(schema_path)
    schema["rules"]["files"]["deriv"]["preprocessed_data"]["anat_nonparametric_common"]["$ref"] = "broken.reference"
...
def test_add_legal_field():
    ...
    schema = load_schema(schema_path)
    schema["rules"]["files"]["deriv"]["preprocessed_data"]["anat_nonparametric_common"]["entities"]["density"] = "optional"
    validate_schema(schema)
...
def test_invalid_value():
    ...
    schema = load_schema(schema_path)
    schema["rules"]["files"]["deriv"]["preprocessed_data"]["anat_nonparametric_common"]["entities"]["density"] = "invalid"
