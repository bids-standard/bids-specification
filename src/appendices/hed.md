...
An error will be generated by the BIDS validator if
your dataset uses HED and the `HEDVersion`
field is missing from the dataset description file. To avoid this,
include a `HEDVersion` field in the dataset_description.json
