...
| CodeURL      | OPTIONAL              | [string][]    | [URI](../02-common-principles.md#uniform-resource indicator) where the code used to generate the derivatives may be found.                                                                                                                                  |
...
This section consists of two keys:
  ...
  - `TermURL`: A [URI](../02-common-principles.md#uniform-resource indicator) to an entity in an ontology corresponding to this tool.
